...
static const char *fonts[]          = { "UbuntuNerdMono:pixelsize=16:antialias=true:autohint=true","SymbolsFontNerdMono:pixelsize=16:antialias=true:autohint=true" };
static const char dmenufont[]       = "UbuntuNerdMono:pixelsize=16:antialias=true:autohint=true";
...
static const Key keys[] = {
	...
	{ 0,                      XF86XK_Explorer, spawn,          {.v = termcmd } },
